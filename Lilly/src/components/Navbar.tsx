      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <img src="/logo.png" alt="Lilly" className="h-8" />
            <Link to="/" className="text-white text-2xl font-medium font-inter tracking-tight drop-shadow-[0_0_3px_rgba(255,192,203,0.5)]">
              Lilly
            </Link>
          </div>
          ...
          <div className="hidden md:block">
            {user ? (
              ...
              <Link 
                to="/signin" 
                className="relative group px-5 py-1.5 rounded-full text-sm"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-[#9747FF] to-[#e9b0ff] rounded-full opacity-80 group-hover:opacity-100 transition-opacity duration-300"></div>
